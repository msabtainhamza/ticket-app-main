...
const Ticket = ({ setShowModal }) => {
  return (
    <div className="md:flex block justify-between items-center mt-4 py-4 border-b border-b-[#0f0f10]">
      ...
      <div
        className="bg-[#7a844a] py-2 px-4 text-[#1b1b1b] text-[19px] md:mt-0 mt-2 rounded-md flex md:justify-between justify-center items-center gap-2 font-semibold cursor-pointer"
...
export default function Upcoming() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f0f10] md:p-11 p-5">
      ...
      <div className="w-full bg-[#1b1b1b] rounded-xl mt-6 md:p-5 p-3">
        ...
        <Ticket setShowModal={setShowModal} />
        <Ticket setShowModal={setShowModal} />
        <Ticket setShowModal={setShowModal} />
        <Ticket setShowModal={setShowModal} />
        <Ticket setShowModal={setShowModal} />
