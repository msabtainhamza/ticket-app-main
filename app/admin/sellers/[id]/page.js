...
export default function Events() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#0f0f10] md:p-9 p-5">
      ...
      <div className="w-full  mt-4 md:flex md:justify-between block items-center">
      ...
      <div className="w-full  mt-4 md:flex justify-between block items-center">
        <RecentActivites />
        <History navigartion={`/admin/sellers/${id}/history`} />
      </div>
    </main>
  );
}
