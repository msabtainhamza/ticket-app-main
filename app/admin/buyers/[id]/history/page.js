    ...
    <main className="min-h-screen w-full bg-[#0f0f10] p-9">
      ...
      <div className="w-full bg-[#2e2e2e] mt-4 p-3 rounded-xl">
        <div className="flex justify-start items-center gap-3">
          <p className="text-white text-[22px] font-bold">History</p>
        </div>
        <div className="flex justify-start items-center gap-5 mt-4 border-b border-b-[#b86c5c] py-1">
          <div
            className={`${
              activeTab === "Weekly" ? "bg-[#8c945a]" : "bg-[#292929]"
            } text-white p-2 rounded-xl text-[12px] font-semibold hover:cursor-pointer`}
        ...
        <div className="overflow-x-auto bg-[#151515] p-5 rounded-xl mt-5">
