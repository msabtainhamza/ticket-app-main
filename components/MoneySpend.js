...
import { data } from "@/constants/moneySpend";

export default function TotalProfiles() {
  return (
    <div className="bg-[#1b1b1b] md:w-[48%] w-full rounded-xl p-4 md:mt-0 mt-4">
      <p className="text-white md:text-[17px] text-[12px] font-bold">
        Money Spend
      </p>
      <div className="flex justify-between items-center">
        <div className="flex justify-between items-center">
          <p className="text-white md:text-[15px] text-[12px] font-bold">$</p>
      ...
      <div className="mt-5 w-full">
        <LineChartGraph data={data} lineKey={"Money Spend"} />
      </div>
    </div>
  );
}
